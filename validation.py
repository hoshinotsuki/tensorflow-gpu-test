...
Original file is located at
    https://colab.research.google.com/github/hoshinotsuki/ML_google/blob/master/4.validation.ipynb
...
preprocess_features(california_housing_dataframe).describe()

preprocess_targets(california_housing_dataframe).describe()
