...
# Your code here
cities['Is wide and has saint name'] =(cities['Area square miles'] > 50) & cities['City name'].apply(lambda val:val.startswith('San'))
cities

"""As > is lower precedence than &, A > X & B is parsed as A > (X & B) but what you want is (A > X) & B.
所以>的运算要加（）
